...
--
-- 54 permissions across 14 resource groups,
-- bundled into 7 system roles (182 grants).
--
...
INSERT INTO "permissions" ("key", "resource", "action", "description", "is_sensitive") VALUES
  ...
  ('agents.archive', 'agents', 'archive', 'archive on agents', false),
  ('agents.sessions.read', 'agents', 'sessions.read', 'sessions.read on agents', true),
  ('agents.sessions.manage', 'agents', 'sessions.manage', 'sessions.manage on agents', false),
...
-- Administrator — 51 of 54 permissions
INSERT INTO "role_permissions" ("role_id", "permission_id")
SELECT r."id", p."id"
FROM "roles" r
CROSS JOIN "permissions" p
...
-- Agent Manager — 28 of 54 permissions
INSERT INTO "role_permissions" ("role_id", "permission_id")
SELECT r."id", p."id"
FROM "roles" r
CROSS JOIN "permissions" p
...
-- Knowledge Manager — 9 of 54 permissions
INSERT INTO "role_permissions" ("role_id", "permission_id")
SELECT r."id", p."id"
FROM "roles" r
CROSS JOIN "permissions" p
...
-- Recruiter / Operator — 24 of 54 permissions
INSERT INTO "role_permissions" ("role_id", "permission_id")
SELECT r."id", p."id"
FROM "roles" r
CROSS JOIN "permissions" p
