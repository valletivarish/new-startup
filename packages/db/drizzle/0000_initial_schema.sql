...
CREATE INDEX "organization_memberships_org_role_idx" ON "organization_memberships" USING btree ("organization_id","role_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "roles_org_key_unique" ON "roles" USING btree ("organization_id","key") WHERE "roles"."organization_id" IS NOT NULL;--> statement-breakpoint
